...
import { provideHttpClient, withInterceptorsFromDi } from '@angular/common/http'; //Use provided Http instead of standalone import -Nolan
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideHttpClient(withInterceptorsFromDi()), //Http providor -Nolan
